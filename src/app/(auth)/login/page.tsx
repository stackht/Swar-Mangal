...
export default function LoginPage() {
  const { loginDemo, loginSupabase, isSupabase, user } = useAuth();
      ...
      >
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-1.5 max-w-xs text-body-sm text-muted-foreground">
            Your premium music academy companion. Explore a demo below.
          </p>
        </div>

        {!isSupabase ? (
          <>
            <p className="mb-3 text-left text-caption uppercase tracking-[0.14em] text-muted-foreground">
              Explore as
            </p>
