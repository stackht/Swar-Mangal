  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={listVariants} className="space-y-6">
      <motion.div variants={fadeUp}>
        ...
        <p className="mt-1 text-sm text-[#F7F2E8]/55">Record a real receipt — locked, countered and audited server-side.</p>
      </motion.div>
        ...
        <div className="space-y-6 lg:col-span-3">
          ...
          <Card className="border-[#F7F2E8]/10 bg-[#17131D]">
            <CardContent className="space-y-4 pt-5">
              ...
              <div className="space-y-2">
                <Label className="text-[#F7F2E8]/70">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <Label className="text-[#F7F2E8]/70">Fee period from</Label>
                  <Input
                    type="date"
                    value={feeFrom}
                    onChange={(e) => {
                ...
                <div className="space-y-2">
                  <Label className="text-[#F7F2E8]/70">Fee period to</Label>
                  <Input
                    type="date"
                    value={feeTo}
              ...
              {success ? (
                ...
                <Button className="w-full bg-[#D6A84F] text-[#08070B] hover:bg-[#E2BD68]" onClick={submit} disabled={!valid} loading={addFee.isPending}>
