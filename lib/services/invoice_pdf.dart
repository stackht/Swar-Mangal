  ...
  doc.addPage(
    pw.MultiPage(
      ...
      build: (_) => [
        ...
        pw.SizedBox(height: 4),
        pw.Text(inv.studentName, style: pw.TextStyle(fontSize: 12)),
        pw.Text('Student ID: ${inv.studentId}', style: pw.TextStyle(fontSize: 11)),
        pw.SizedBox(height: 3),
        pw.Text('Class: ${inv.displayClassName}', style: pw.TextStyle(fontSize: 11)),
        pw.Text('Course: ${inv.course.isNotEmpty ? inv.course : '—'}',
            style: pw.TextStyle(fontSize: 11)),
        pw.Text('Teacher: ${inv.teacherName.isNotEmpty ? inv.teacherName : '—'}',
            style: pw.TextStyle(fontSize: 11)),
        ...
        pw.SizedBox(height: 4),
        pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [
          pw.Text('Music Classes', style: pw.TextStyle(fontSize: 12)),
